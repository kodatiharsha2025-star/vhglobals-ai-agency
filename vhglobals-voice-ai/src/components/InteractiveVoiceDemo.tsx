...
export const InteractiveVoiceDemo: React.FC<InteractiveVoiceDemoProps> = ({ onOpenOnboarding }) => {
  ...
  const handleTestCustomPrompt = () => {
    ...
    let reply = `Hello! This is ${agent.name} from VHGlobals. Yes, absolutely! We support over 95 languages with real-time accent adaptation and sub-500ms response speed.`;
